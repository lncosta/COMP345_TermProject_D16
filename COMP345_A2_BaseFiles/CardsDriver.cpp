...
void cardDriver() {
	...
	cout << "The player's hand currently contains this:" << endl << endl << *(player1.getPlayerHand()) << endl;
	...
	cout << *(player1.getPlayerHand()) << endl;
	...
	while (player1.getPlayerHand()->getHandOfCards().size() > 0) {
		player1.getPlayerHand()->getHandOfCards().at(0)->play(player1, deck1);
	}
	...
	cout << "For hand: \n";
	cout << "\nhand1 contents: " << *(player1.getPlayerHand()) << endl;
	cout << "\nCreating hand2 and using the assignment operator:";
	Hand hand2;
	hand2 = *(player1.getPlayerHand());
